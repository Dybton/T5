...
initial_training_checkpoint_path = f"checkpoints/training_checkpoint_{train_set}7.ckpt"
...
fine_tuning_checkpoint_path = f"checkpoints/fine_tuned_checkpoint_{train_set}7.ckpt"
